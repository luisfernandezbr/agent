...
func templateReadmeMdTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/README.md.tmpl", size: 167, mode: os.FileMode(420), modTime: time.Unix(1591357869, 0)}
...
func templateGoModTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/go.mod.tmpl", size: 249, mode: os.FileMode(420), modTime: time.Unix(1591357869, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateIntegrationYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/integration.yaml.tmpl", size: 2011, mode: os.FileMode(420), modTime: time.Unix(1591357939, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templateInternalRootGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/internal/root.go.tmpl", size: 2268, mode: os.FileMode(420), modTime: time.Unix(1591357869, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
